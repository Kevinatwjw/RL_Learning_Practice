...
from Policygradient_baseline_class import REINFORCE_Baseline
...
if __name__ == "__main__":
    ...
    # build agent
    agent = REINFORCE_Baseline(state_dim, hidden_dim, action_range, gamma, lr_policy, lr_value,  device)
