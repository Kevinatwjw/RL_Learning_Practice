...
from RL_DQN_Class import ReplayBuffer,DuelingDON,DoubleDQN
...
if __name__ == "__main__":
    ...
    agent = DuelingDON(state_dim, hidden_dim, action_dim, action_range, lr, gamma, epsilon_start, tau, device)
    # 创建 DuelingDON 代理（假设 DuelingDON 类已定义）
