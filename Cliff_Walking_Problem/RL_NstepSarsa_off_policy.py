...
from RL_Solver_Class import NstepSarsa_Off_policy
import numpy as np
...
epsilon = 0.1           # 初始探索率
alpha = 0.1             # 初始学习率
agent = NstepSarsa_Off_policy(wrapper_env, alpha=alpha, gamma=0.9, epsilon=epsilon, seed=50, nstep=5)  # 创建NstepSarsa(Off_policy)智能体
