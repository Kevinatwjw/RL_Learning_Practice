...
if __name__ == "__main__":
    ...
    # build agent
    agent = TRPO(state_dim, hidden_dim, action_range, lmbda, kl_constraint, alpha, critic_lr, gamma, device)
    ...
    plt.title(f'{agent._get_name()} on CartPole-v0 with {reward_type} reward')
    # 显示图例
    plt.legend()
    # 保存图像到 result 目录
